# Contributing to ml-google-geocode

ml-google-geocode welcomes new contributors. This document will guide you
through the process.
...
If you have questions about how to use ml-google-geocode, check our documentation on the [Wiki][wiki]. Alternatively, check [Stack Overflow][mlstack] to see if it has been answered there, and post your question there if not. Please tag it with MarkLogic, and AngularJS.
...
* **ml-google-geocode Version** - is it a named version or from our master branch
...
#### Fork ml-google-geocode

Fork the project [on GitHub](https://github.com/grtjn/ml-google-geocode/fork) and clone
your copy.

```sh
$ git clone git@github.com:username/ml-google-geocode.git
$ cd ml-google-geocode
$ git remote add upstream git://github.com/grtjn/ml-google-geocode.git
```
...
Go to https://github.com/username/ml-google-geocode and select your feature branch. Click
...
[wiki]: https://github.com/grtjn/ml-google-geocode/wiki
[mlstack]: http://stackoverflow.com/questions/tagged/marklogic
[issue tracker]: https://github.com/grtjn/ml-google-geocode/issues
